...
<div class="form-group col-sm-6">
  ...
  <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
    <input id="startDate" type="text" name="start_date" class="form-control datetimepicker-input" data-target="#datetimepicker1"/>
...
<div class="form-group col-sm-6">
  ...
  <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
    <input id="endDate" type="text" name="end_date" class="form-control datetimepicker-input" data-target="#datetimepicker2"/>
